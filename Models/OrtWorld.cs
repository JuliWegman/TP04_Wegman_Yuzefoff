...
public static List<string> ListaHoteles {get; private set;}=new List<string>{"Hilton.jfif", "Hotel llao llao.jpg", "Costa Galana.webp", "Casa Crespo Hotel Boutique.jfif", "Patios del Mediterraneo Apart Hotel.jfif", "Libertador.jfif","Rayentray Puerto Madryn.jfif", "La Morada Petit Hotel.jfif","Hotel Bicentenario Suites & Spa.jfif","macabi.jpg"};
public static List<string> ListaAereos {get; private set;}=new List<string>{"aerolineas_argentinas.png", "Alaska Airlines.png", "British Airways.png", "Delta.png", "Ethiopian.png", "Japan Airlines.png","LAN.png", "Lufthansa.png","Singapur.png","turkish_airlines.png"};
